...
(ABAP)** and its associated country projects (like SABAP2).
...
If you know the English common name, you can quickly retrieve the code.
...
Generates a map showing the total full-protocol survey hours (effort)
per pentad. Categories are dynamically adjusted based on the maximum
effort level found in the country.
...
# 3. Review Codes (show_codes)

Utility to quickly print a list of species codes to the console before
running a batch process.

``` r
show_codes(c(129, 311, 437, 846))
```
